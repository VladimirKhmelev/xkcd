...
Страница поиска позволяет искать комиксы по фразе прямо в браузере — введите запрос, выберите количество результатов (10 / 20 / 50 / 100) и нажмите **Search**. Результаты отображаются в виде сетки картинок со ссылками на оригинальные страницы xkcd.com.
